    ...
    <script>
        ...
        layui.use([ 'laypage', 'jquery','layer', 'table',  'upload', 'element'], function(){
            ...
            table.render({
                ...
                ,elem: '#demo'
                ,cellMinWidth:80
                ,url: '${pageContext.request.contextPath}/site?method=viewAll' //数据接口
                ,title: '用户表'
                ,page: true //开启分页
                ,toolbar: '#headerBtns' //开启工具栏，此处显示默认图标，可以自定义模板，详见文档
                ,totalRow: true //开启合计行
                , cols: [[ //表头
                    {field: 'adId', title: '场地编号',  sort: true}
                    ,{field:'adName', title: '场地名称'}
                    ,{field:'address', title: '场地地点'}
                    ,{field:'adText', title: '场地描述'}
        ...
        function del1(data){
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        $.post('${pageContext.request.contextPath}/site?method=del&id='+id,function(data){
                            if(data.data>0){
                                swal("删除！", "删除成功",
                                    "success");
                            }else {
        ...
        function save(){
            ...
            $("#myModal").modal("hide") ;
                    $.post('${pageContext.request.contextPath}/site?method=add&name='+name+"&address="+address+"&beizhu="+beizhu,function(data){
        ...
        function validateAdd() {
            ...
            if(address == null || address == ""){
                $("#address").parent().append("<span style='color:red'>请输入场地地址</span>");
                return false;
            }
        ...
        function upd(){
            ...
            $("#myModal2").modal("hide") ;
                    ...
                    $.post('${pageContext.request.contextPath}/site?method=upd&id='+id+"&name="+name+"&address"+address+"&beizhu"+beizhu,function(data){
                        if(data.data>0){
                            swal("修改！", "修改成功",
                                "success");
                        }else {
        ...
        function validateUpd() {
            ...
            if(xgaddress == null || xgaddress == ""){
                $("#xgaddress").parent().append("<span style='color:red'>请输入场地地点</span>");
                return false;
            }
          return true;
        }
...
<div class="panel-body">
    <form class="form-inline">
        <div  class="input-group input-daterange">
            <label for="cardid" class="control-label">场地名称:</label>
...
<script type="text/html" id="headerBtns">
    <button class="layui-btn layui-btn-sm" lay-event="addNewMember" id="addBtn" >添加场地</button>
</script>
<!--行工具栏-->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">增加场地</h4>
            </div>
            <div class="modal-body">
                <!-- form开始 -->
                <form>
                    <div class="form-group">
                        <label for="name" class="col-sm-4 control-label"style="margin-top: 10px">场地名称</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label for="address" class="col-sm-4 control-label"style="margin-top: 10px">场地地点</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label for="beizhu" class="col-sm-4 control-label"style="margin-top: 10px">场地描述</label>
                        <div class="col-sm-8">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel2">修改场地</h4>
            </div>
            <div class="modal-body">
                <!-- form开始 -->
                <form>
                    ...
                    <div class="form-group">
                        <label for="xgname" class="col-sm-4 control-label"style="margin-top: 10px">场地名称</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label for="xgaddress" class="col-sm-4 control-label"style="margin-top: 10px">场地地点</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label for="xgbeizhu" class="col-sm-4 control-label"style="margin-top: 10px">场地描述</label>
                        <div class="col-sm-8">
